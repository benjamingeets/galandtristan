...
<a target="_blank" class="mx-2" href="https://linkedin.com/in/galandtristan">
    <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M3.02272 0C1.35162 0 0 1.35162 0 3.02272C0 4.69382 1.35162 6.07493 3.02272 6.07493C4.69382 6.07493 6.04544 4.6889 6.04544 3.02272C6.04053 1.35162 4.6889 0 3.02272 0Z" fill="{colorIcon}"/>
        </svg>
